<template>
  <div class="booking-form">
    <p class="booking-form__info">{{info}}</p>
    ...
    <div class="booking-form__messages" v-if="error || valid">
      ...
      <p
        ...
        v-if="error === DEPARTURE_BEFORE_ARRIVAL"
      >{{ departureBeforeArrivalMessage }}</p>
  ...
  computed: {
    ...
    isDisabled() {
      return (
        ...
        ((this.equipment !== 'mobilhome' || this.equipment !== 'villatent') &&
    ...
    info() {
      return this.$i18n.t('booking.form.info');
    },
    button() {
...
.booking-form__submit:hover {
  box-shadow: 0 3px 6px -2px rgba(0, 0, 0, 0.2), 0 6px 8px 0 rgba(0, 0, 0, 0.14),

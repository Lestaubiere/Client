<template>
  <div class="table">
    ...
    <div class="table__content">
      <div class="table__row" v-for="(row, index) in rows" :key="index">
        <div class="table__column">
          <span>{{ row.title }}</span>
        </div>
        <div class="table__column" v-for="(column, index) in row.data" :key="index">
          <span :class="column ? 'table__column--green' : 'table__column--red'">
            <span class="table__header-label" v-if="columns[index]">{{ columns[index] }}</span>
          </span>
        </div>
      </div>
    </div>
